...
function assignDefaults(dir, userConfig, silent) {
    ...
    if (((_result_experimental = result.experimental) == null ? void 0 : _result_experimental.ppr) && !"14.0.3".includes("canary") && !process.env.__NEXT_TEST_MODE) {
    ...
    if (path == null ? void 0 : path.length) {
        ...
        try {
            ...
            if (process.env.__NEXT_TEST_MODE === "jest") {
                ...
                tempConfigPath = await (0, _transpileconfig.transpileConfig)({
                    configPath: path,
                    configFileName,
                    cwd: dir,
                    log: curLog
