...
const _findup = /*#__PURE__*/ _interop_require_default(
...
const _transpileconfig = require('../build/transpile-config')
...
function processZodErrorMessage(issue) {
  ...
  if (issue.code === 'invalid_enum_value') {
    ...
    return `Expected ${_zod.util.joinValues(issue.options)}, received '${
      issue.received
    }' at ${path}`
  }
...
function assignDefaults(dir, userConfig, silent) {
  ...
  if (
    ...
    !'14.0.2-canary.18'.includes('canary')
  ) {
    _log.warn(
  ...
  if (
    typeof ((_result_experimental2 = result.experimental) == null
      ? void 0
      : _result_experimental2.serverActions) === 'boolean'
  ) {
  ...
  if (
    typeof ((_result_experimental3 = result.experimental) == null
      ? void 0
      : (_result_experimental_serverActions =
          _result_experimental3.serverActions) == null
      ? void 0
  ...
  if (
    ((_result_experimental4 = result.experimental) == null
      ? void 0
      : _result_experimental4.outputFileTracingRoot) &&
  ...
  if (
    ((_result_experimental5 = result.experimental) == null
      ? void 0
      : _result_experimental5.useDeploymentId) &&
  ...
  if (
    (_result_experimental6 = result.experimental) == null
      ? void 0
      : _result_experimental6.useDeploymentIdServerActions
  ) {
  ...
  if (
    !((_result_experimental7 = result.experimental) == null
      ? void 0
      : _result_experimental7.outputFileTracingRoot)
  ) {
  ...
  if (result.i18n) {
    ...
    if (i18n.domains) {
      const invalidDomainItems = i18n.domains.filter((item) => {
        ...
        const defaultLocaleDuplicate =
          (_i18n_domains = i18n.domains) == null
            ? void 0
            : _i18n_domains.find(
                (altItem) =>
  ...
  const userProvidedOptimizePackageImports =
    ((_result_experimental8 = result.experimental) == null
      ? void 0
      : _result_experimental8.optimizePackageImports) || []
  if (!result.experimental) {
    result.experimental = {}
  }
...
async function loadConfig(
  phase,
  dir,
  { customConfig, rawConfig, silent = true, onLoadUserConfig } = {}
) {
  ...
  if (path == null ? void 0 : path.length) {
    ...
    try {
      ...
      if (process.env.__NEXT_TEST_MODE === 'jest') {
        ...
        const code = await (0, _transpileconfig.transpileConfig)({
          configPath: path,
          configFileName,
          cwd: dir,
          log: curLog,
        ...
        userConfigModule = await import(
          (0, _url.pathToFileURL)(tempConfigPath).href
        )
      } else {
      ...
      if (tempConfigPath) await (0, _promises.unlink)(tempConfigPath)
    }
    const userConfig = await (0, _configshared.normalizeConfig)(
      phase,
    ...
    if (
      ((_userConfig_experimental = userConfig.experimental) == null
        ? void 0
        : (_userConfig_experimental_turbo = _userConfig_experimental.turbo) ==
          null
        ? void 0
        : _userConfig_experimental_turbo.loaders) &&
      !((_userConfig_experimental1 = userConfig.experimental) == null
        ? void 0
        : (_userConfig_experimental_turbo1 = _userConfig_experimental1.turbo) ==
          null
        ? void 0
    ...
    const configBaseName = (0, _path.basename)(
      _constants.CONFIG_FILES[0],
      (0, _path.extname)(_constants.CONFIG_FILES[0])
    )
    const notSupportedConfigPath = _findup.default.sync(
      [
        `${configBaseName}.jsx`,
        `${configBaseName}.tsx`,
        `${configBaseName}.json`,
    ...
    if (
      notSupportedConfigPath == null ? void 0 : notSupportedConfigPath.length
    ) {
      throw new Error(
        `Configuring Next.js via '${(0, _path.basename)(
